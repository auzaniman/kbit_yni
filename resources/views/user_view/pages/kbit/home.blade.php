...
<div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6">
  ...
  <div class="container">
    <div class="row">
      <div class="row justify-content-center text-center my-sm-5">
        <div class="col-lg-6">
          <span class="badge bg-danger mb-3">Visi KBIT</span>
        ...
        <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4 mb-5 mb-lg-0">
          <div class="rotating-card-container">
            <div class="card card-rotate card-background card-background-mask-success shadow-success mt-md-0 mt-5">
              <div class="front front-background" style="background-image: url(frontend/assets/img/KBIT/3.jpeg); background-size: cover;">
                <div class="card-body py-7 text-center">
                  <i class="material-icons text-white text-4xl my-3">touch_app</i>
                  <h3 class="text-white">Jelajahi <br /> KBIT Nurul 'Ilmi</h3>
                  <p class="text-white opacity-8">Mengenal program dan bidang KBIT dalam pengembangan didunia pendidikan.</p>
                </div>
              </div>
              <div class="back back-background" style="background-image: url(frontend/assets/img/KBIT/2.jpeg); background-size: cover;">
                <div class="card-body pt-7 text-center">
                  <h3 class="text-white">Jelajahi KBIT</h3>
                  <p class="text-white opacity-8">Mengenal program dan bidang KBIT dalam pengembangan didunia pendidikan.</p>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="position-sticky pb-lg-5 pb-3 mt-lg-0 mt-5 ps-2" style="top: 100px">
            <h3>Jelajahi KBIT Nurul 'Ilmi</h3>
                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col-lg-6 my-auto">
                            ...
                            <p class="pe-5">Segudang prestasi sekolah KBIT Nurul Ilmi Tenggarong.</p>
                          </div>
                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col-lg-6 my-auto">
                            ...
                            <p class="pe-5">Berikut adalah fasilitas KBIT Nurul Ilmi Tenggarong.</p>
                          </div>
                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col-lg-6 my-auto">
                            ...
                            <p class="pe-5">Berikut adalah program unggulan KBIT Nurul Ilmi Tenggarong.</p>
                          </div>
                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col-lg-6 my-auto">
                            ...
                            <p class="pe-5">Berikut adalah kegiatan Ekstra pengembangan potensi siswa KBIT Nurul Ilmi Tenggarong.</p>
                          </div>
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="row mt-4">
            <div class="col-md-6">
              <a href="">
                <div class="card move-on-hover">
                  <img class="w-100" src="{{ url('frontend/assets/img/KBIT/1.jpeg')}}" alt="aboutus">
                </div>
                <div class="mt-2 ms-2">
                  <h6 class="mb-0">-</h6>
                </div>
            ...
            <div class="col-md-6 mt-md-0 mt-5">
              <a href="">
                <div class="card move-on-hover">
                  <img class="w-100" src="{{ url('frontend/assets/img/KBIT/2.jpeg')}}" alt="contacus">
                </div>
                <div class="mt-2 ms-2">
                  <h6 class="mb-0">-</h6>
                </div>
            ...
            <div class="col-md-6 mt-md-3 mt-6">
              <a href="">
                <div class="card move-on-hover">
                  <img class="w-100" src="{{ url('frontend/assets/img/KBIT/3.jpeg')}}" alt="signin">
                </div>
                <div class="mt-2 ms-2">
                  <h6 class="mb-0">-</h6>
                </div>
            ...
            <div class="col-md-6 mt-md-3 mt-6">
              <a href="">
                <div class="card move-on-hover">
                  <img class="w-100" src="{{ url('frontend/assets/img/KBIT/4.jpeg')}}" alt="author">
                </div>
                <div class="mt-2 ms-2">
                  <h6 class="mb-0">-</h6>
                </div>
        ...
        <div class="col-md-3 mx-auto mt-md-0 mt-5">
          <div class="position-sticky" style="top:100px !important">
            <h4 class="">Galeri KBIT Nurul 'Ilmi</h4>
            <h6 class="text-secondary font-weight-normal">Bagian dari landscape kegiatan kami sekolah KBIT Nurul 'Ilmi</h6>
          </div>
        </div>
      </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 text-start mb-5 mt-5">
          <h3 class="text-white z-index-1 position-relative">Guru-guru KBIT Nurul 'Ilmi Tenggarong</h3>
  ...
  <section class="py-5 mt-5">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <h3 class="mb-5">Informasi Berita KBIT Nurul 'Ilmi</h3>
        </div>
      </div>
      <div class="row">
      ...
      <div class="container py-7 postion-relative z-index-2 position-relative">
        <div class="row">
          <div class="col-md-7 mx-auto text-center">
            <h3 class="text-white mb-0">KBIT Nurul 'Ilmi Tenggarong</h3>
            <h3 class="text-white">Daftarkan segera putra putri anda disekolah KBIT Nurul 'Ilmi</h3>
            ...
            <a href="https://ynikoetaikartanagara.com/ppdb/smait_create" class="btn btn-info btn-lg mb-3 mb-sm-0">Pendaftaran Online KBIT</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 col-12 my-auto">
          <h3 class="text-gradient text-danger mb-0">KBIT Nurul 'Ilmi</h3>
          <h3>Tenggarong</h3>
          <p class="pe-md-5 mb-4">
            KBIT Nurul ‘Ilmi Tenggarong merupakan SD berkonsep Islam Terpadu pertama berdiri di Kalimantan. KBIT Nurul ’Ilmi Tenggarong menyelenggarakan pendidikan sesuai dengan kurikulum nasional yang diperkaya dengan nilai-nilai Islam. Berkomitmen mengimplementasikan sistem pendidikan Islam secara terpadu untuk melahirkan generasi muslim terbaik menuju terwujudnya kejayaan Islam.
          </p>
        </div>
        <div class="col-md-5 col-12 my-auto">
          <a href="https://www.creative-tim.com/product/material-kit-pro?ref=index-mk2">
            <img class="w-100 border-radius-lg shadow-lg" src="{{ url('frontend/assets/img/KBIT/1.jpeg')}}" alt="Product Image">
          </a>
        </div>
      </div>
    </div>
