  ...
  <div class="container">
    <div class=" row">
      <div class="col-md-3 mb-4 ms-auto">
        <div>
          <a href="">
            <img src="{{ url('frontend/assets/img/KBIT/logo.png')}}" class="mb-3 footer-logo" alt="main_logo">
          </a>
          <h6 class="font-weight-bolder mb-4">KBIT Nurul 'Ilmi</h6>
        </div>
        <div>
      ...
      <div class="col-12">
        <div class="text-center">
          <p class="text-dark my-4 text-sm font-weight-normal">
            All rights reserved. Copyright © <script>document.write(new Date().getFullYear())</script> KBIT Nurul 'Ilmi Tenggarong by <a href="https://www.ynikoetaikartanagara.com" target="_blank">IT YNI Team</a>.
          </p>
        </div>
      </div>
    </div>
